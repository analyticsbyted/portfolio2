    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-normal font-headline">
            Let's Work
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-6">
              {contactMethods.map((method, index) => (
                <a key={index} href={method.link} target="_blank" rel="noopener noreferrer" className="flex items-center p-6 bg-card dark:bg-card rounded-2xl border-2 border-border dark:border-gray-700 hover:border-brand-primary dark:hover:border-brand-primary hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                  <div className="text-4xl mr-6">{method.icon}</div>
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-brand-primary dark:group-hover:text-brand-accent transition-colors">{method.title}</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-2">{method.description}</p>
                    <span className="text-brand-primary dark:text-brand-accent font-medium">{method.label}</span>
                  </div>
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-brand-primary dark:group-hover:text-brand-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-brand-primary/10 dark:to-brand-secondary/10 rounded-2xl p-6 border border-brand-primary/20 dark:border-brand-primary/30">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-brand-primary/10 dark:bg-brand-primary/20 text-brand-primary dark:text-blue-200 rounded-full text-sm font-medium">Consulting Available</span>
                <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 rounded-full text-sm font-medium">Open to Collaboration</span>
                <span className="px-3 py-1 bg-brand-secondary/10 dark:bg-brand-secondary/20 text-brand-secondary dark:text-purple-200 rounded-full text-sm font-medium">Speaking Opportunities</span>
              </div>
            </div>
          </section>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    {...register('name')}
                    className={`w-full px-6 py-4 rounded-xl border-2 bg-gray-50 dark:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-brand-primary/20 focus:border-brand-primary transition-all duration-300 text-lg ${errors.name ? 'border-red-500' : 'border-border dark:border-gray-600'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    id="email"
                    {...register('email')}
                    className={`w-full px-6 py-4 rounded-xl border-2 bg-gray-50 dark:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-brand-primary/20 focus:border-brand-primary transition-all duration-300 text-lg ${errors.email ? 'border-red-500' : 'border-border dark:border-gray-600'}`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    {...register('message')}
                    rows={6}
                    className={`w-full px-6 py-4 rounded-xl border-2 bg-gray-50 dark:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-brand-primary/20 focus:border-brand-primary transition-all duration-300 text-lg resize-none ${errors.message ? 'border-red-500' : 'border-border dark:border-gray-600'}`}
