      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          >
            {articles.map((article) => (
              <motion.div
                key={article.id}
                variants={itemVariants}
                className="bg-surface/40 dark:bg-surface-dark/40 backdrop-blur-xl rounded-3xl shadow-sm border border-white/20 dark:border-white/5 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
              >
                <div className="p-8">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-surface/40 dark:bg-surface-dark/40 backdrop-blur-xl rounded-3xl shadow-sm border border-white/20 dark:border-white/5 hover:shadow-lg transition-all duration-300">
