    ...
    <div className="max-w-6xl mx-auto p-8 bg-card dark:bg-gray-800 rounded-2xl shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="text-center p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
          ...
          <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Current Enhanced</h3>
      ...
      <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
        <h4 className="font-semibold text-gray-900 dark:text-white mb-4">2024 Design Analysis:</h4>
