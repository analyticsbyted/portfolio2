    ...
    <div className="max-w-4xl mx-auto p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="text-center">
          ...
          <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Current Logo</h3>
        ...
        <div className="text-center">
          ...
          <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Option 1: Enhanced</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="text-center">
          ...
          <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Option 2: Personal</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm">
      ...
      <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
        <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Design Analysis:</h4>
