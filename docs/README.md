...
This folder documents the application architecture, setup, and operational guides for this project.
...
- **Context & Handover** (`context.md`): Comprehensive project context for smooth handover
- **Architecture** (`architecture.md`): High-level architecture, decisions, and patterns
- **Development** (`development-workflow.md`): Development workflow, best practices, common tasks
